         ...
         <form action="sign-up.php" method="post">
            ...
            <div class="data">
               ...
               <div class="form-check form-check-inline">
                  ...
                  <label class="form-check-label text-nowrap">Non Aktif</label>
               </div>
               ...
               <div class="button" style="background: rgb(131,58,180);">
                  <div class="inner"></div>
                  <button type="submit" name="register">Daftar</button>
               </div>
               <div class="signup-link">
                  Sudah memiliki akun ? <a href="sign-in.php">Login Sekarang</a>
               </div>
            </div>
         </form>
      </div>
